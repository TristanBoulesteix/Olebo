...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            val kotlinVersion = version("kotlin", "1.6.21")
            val exposedVersion = version("exposed", "0.38.2")
            val coroutinesVersion = version("coroutines", "1.6.2")
            val ktorVersion = version("ktor", "2.0.3")
            val serialisationVersion = version("serialisation", "1.3.2")
            val composeVersion = version("compose", "1.2.0-alpha01-dev686")
            val kmdcVersion = version("kmdc", "0.0.4")
            ...
            // serialization
            library("serialization", "org.jetbrains.kotlinx", "kotlinx-serialization-json").versionRef(
